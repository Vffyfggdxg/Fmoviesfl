...
URL = "https://free-v2cr.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://free-v2cr.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://free-v2cr.onrender.com/".format(FQDN)
else:
    URL = "https://free-v2cr.onrender.com/".format(FQDN)
