...
API_ID = int(environ.get('API_ID', '26165672'))
API_HASH = environ.get('API_HASH', '0a6b41785ed65d44ae5e9ad2a0674700')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1096151919').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002089323759').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anandber200:oUSlgutseoecnBEJ@cluster0ffgg.hvfyygw.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002089323759'))
...
URL = "https://demo-x8w6.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-x8w6.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-x8w6.onrender.com/".format(FQDN)
else:
    URL = "https://demo-x8w6.onrender.com/".format(FQDN)
