...
URL = "https://freeggg.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://freeggg.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://freeggg.onrender.com/".format(FQDN)
else:
    URL = "https://freeggg.onrender.com/".format(FQDN)
